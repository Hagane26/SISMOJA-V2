...
@section('isi')
    <div class="position-absolute top-0 start-50 translate-middle-x mt-3">
        ...
        <div class="position-relative mt-4 mb-5">
            ...
            <a href="/modul/tambah/pertemuan/2" type="button" class="position-absolute top-0 translate-middle btn btn-sm btn-{{ $res['pos'] == 1 ? 'primary' : ($res['pos'] > 1 ? 'success' : 'secondary') }} rounded-pill" style="width: 2rem; height:2rem; margin-left:20%;">2</a>
            <a href="/modul/tambah/pertemuan/3" type="button" class="position-absolute top-0 translate-middle btn btn-sm btn-{{ $res['pos'] == 1 ? 'primary' : ($res['pos'] > 1 ? 'success' : 'secondary') }} rounded-pill" style="width: 2rem; height:2rem; margin-left:20%;">3</a>
            <a href="/modul/tambah/pertemuan/4" type="button" class="position-absolute top-0 translate-middle btn btn-sm btn-{{ $res['pos'] == 1 ? 'primary' : ($res['pos'] > 1 ? 'success' : 'secondary') }} rounded-pill" style="width: 2rem; height:2rem; margin-left:20%;">4</a>
        </div>
